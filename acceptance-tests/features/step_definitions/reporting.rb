...
When(/^I generate a report expecting results$/) do
  ...
  myXpath = "//*[@id='skill1']"
  myDescription = "67 - TEST DATA - please leave. ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz"
  sleep (10)
  puts 'select skills 67'
  ...
  sleep (10)
  puts 'select skills 68'
  select_skill_description(myXpath, myDescription)

  myXpath = "//*[@id='categ3']"
  mySkill = "Knowledge"
  sleep (10)
  puts 'select knowledge1'
  select_skill(myXpath, mySkill)
